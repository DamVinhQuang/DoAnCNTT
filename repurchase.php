                        ...
                        <div class="col-md-5 order-details">
                            ...
                            <div class="order-summary">
                                ...
                                <div class="order-products">
                                    ...
                                    ?>
                                                <div class="order-col">
                                                    ...
                                                    <div style="max-width:440px;"><?php echo number_format($value1['price']) ?><sub>đ</sub></div>
                                                </div>
                                ...
                                <div class="order-col">
                                    ...
                                    <div><strong class="order-total"><?php echo number_format($value['total']) ?><sub>đ</sub></strong></div>
                                </div>
                            </div>
                <?php
