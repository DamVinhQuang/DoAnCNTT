...
//     if ($_GET['type_id']=='1') {
//         echo "<script> alert('Giá trị đơn hàng phải lớn hơn 100.000VNĐ'); </script>";
//         echo '<script>window.history.pushState({}, document.title, "/" + "location:"cart.php");</script>';
//     }}
?>
                                                    ...
                                                    <tbody>
                                                            ...
                                                            <tr class="cart_item">
                                                                ...
                                                                <td class="product-price">
                                                                    <span class="amount"><?php echo number_format($value['price']) ?><sub>đ</sub></span>
                                                                </td>
                                                                ...
                                                                <td class="product-subtotal">
                                                                    ...
                                                                    $total += $value['price'] * $qty; ?><sub>đ</sub></span>
                                                                </td>
                                                            </tr>
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            <tr class="order-total">
                                                <th>Tổng</th>
                                                <td><strong><span class="amount"><?php echo number_format($total) ?><sub>đ</sub></span></strong> </td>
                                            </tr>
                                        </tbody>
                                    </table>
